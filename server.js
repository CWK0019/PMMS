...
httpServer.listen(port, function() {
    ...
    //ivt=0&flt=3&dia=1&newf=1&diab=f22&diac=000&bb=f22&bc=fff&posflt=1&posdia=1
    console.log(`url: http://localhost:${port}/?ivt=0&flt=9&dia=1&newf=1&diab=f22&diac=fff&bb=f22&bc=fff&posflt=1&posdia=1`);
    console.log(`url: http://localhost:${port}/build/?ivt=0&flt=9&dia=1&newf=1&diab=f22&diac=fff&bb=f22&bc=fff&posflt=1&posdia=1`);
